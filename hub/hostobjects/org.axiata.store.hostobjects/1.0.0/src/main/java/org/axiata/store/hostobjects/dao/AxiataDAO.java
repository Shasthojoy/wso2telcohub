package org.axiata.store.hostobjects.dao;
...
import org.axiata.store.hostobjects.model.Operator;
...
//					operatorStr = operatorStr + "," +operator.getOperatorName();
//					
//				} else {
//					operatorStr = operator.getOperatorName();
//				}
//			}
			ps = conn.prepareStatement(query);
