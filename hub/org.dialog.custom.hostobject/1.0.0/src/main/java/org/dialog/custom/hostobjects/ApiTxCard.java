...
public class ApiTxCard {
    ...
    private void readTxCard() {
        ...
        try {
            ...
            //String content = new String(Files.readAllBytes(Paths.get("E:/HO/TxCard.xml")));
            ...
            while(apiElements.hasNext()){
                ...
                while(paramList.hasNext()){
                    ...
                    //Header Param Loop
                    //System.out.println("    HEADER :: "+paramValue);
                ...
                while(rowList.hasNext()){
                    ...
                    //System.out.println("        FIELDS :: type: "+manipulatioType+" field: "+manipulationField+" regEx: "+manipulationRegEx);
                }
