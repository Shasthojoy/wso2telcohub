...
//		                                                              .getAPIManagerConfiguration();
        ...
        switch (rate.getType()) {
            ...
            case PERCENTAGE:
                ...
                if (prodKey != null) {
                    ...
                    Set<PaymentRequestDTO> paymentRequestSet = BillingDataAccessObject.getPaymentAmounts(Short.parseShort(subsYear), Short.parseShort(subsMonth),
                            consumerKey, api_version, operatorSubscription.getOperator(), operatorSubscription.getOperationId(), categoryEntry.getKey().getCategory(), categoryEntry.getKey().getSubcategory());
    ...
    private static void applyChargesWithTax(String apiYear, String apiMonth, Application application, String apiName, String apiVersion,
        ...
        if (prodKey != null) {
            ...
            requestTimes = TaxDataAccessObject.getAPIRequestTimesForSubscription(Short.parseShort(year),
                    Short.parseShort(month), apiName,
                    api_version, prodKey.getConsumerKey(), operatorSub.getOperator(), operatorSub.getOperationId(), CatEntry.getKey().getCategory(), CatEntry.getKey().getSubcategory());
...
//                BillingDataAccessObject.printSouthboundTraffic();
    ...
    private static void populateOperatorDetailsOfSubscription(BillingSubscription subscription, Map<RateKey, ChargeRate> rateCard) throws APIManagementException, APIMgtUsageQueryServiceClientException {
        ...
        List<OperatorDetailsEntity> operatorMap = BillingDataAccessObject.getOperatorDetailsOfSubscription(appId, apiId);
    ...
    private static void populateCategoryViseAPICounts(BillingSubscription subscription)
        ...
        for (BillingSubscription.OperatorSubscription operatorSubscription : subscription.getOperatorSubscriptionList()) {
            ...
            if (prodKey != null) {
                categoryCharges = BillingDataAccessObject.getAPICountsForSubscription(prodKey.getConsumerKey(),
                        Short.parseShort(subscription.getYear()), Short.parseShort(subscription.getMonth()),
                        subscription.getApiId().getApiName(), subscription.getApiId().getVersion(), operatorSubscription.getOperator(), operatorSubscription.getOperationId());
            }
    ...
    public static NativeArray generateCustomrCareDataReport(
            ...
            String api, String stLimit, String endLimit, String timeOffset) throws SQLException,
    ...
    public static String generateCustomrCareDataRecordCount(boolean isPersistReport, String fromDate, String toDate, String msisdn, String subscriberName, String operator, String app, String api) throws IOException, SQLException,
            APIMgtUsageQueryServiceClientException,
            APIManagementException {
    ...
    public static NativeArray generateCustomTrafficReport(boolean isPersistReport,
        ...
        if (currentDao != null && isPersistReport) {
            ...
            ResultSet rs = BillingDataAccessObject.getTxLogData(fromDate, toDate, subscriberName, operator, operationType, resType);
    ...
    public static NativeArray generateReportofSubscriber(boolean isPersistReport,
        ...
        if (isPersistReport) {
            ...
            /* fileWriter.write(String.format("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s %n", "Subscriber",
             "Application", "API", "Version", "Operator", "Plan","Count",
             "Usage Charge", "Tax", "Credit", "Grand Total")); */
            fileWriter.write(String.format("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s,%s, %s, %s, %s, %s, %s %n", "Subscriber",
                    "Application", "API", "Version", "Operator", "Operation", "Plan", "Currency", "Merchant", "Category", "SubCategory", "Tier", "Count",
        ...
        if (subscriberName.equals(ALL_SUBSCRIBERS_KEYWORD)) {
            ...
            for (String sub : subscriberNames) {
                Map<Application, Set<BillingSubscription>> billingSubs = SbHostObjectUtils.chargeSubscriberForMonth(sub,
                        year,
                        month,
                        rateCard);
                ...
                if (isPersistReport && fileWriter != null) {
                    fileWriter.write(String.format("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s, %s, %s, %s, %s, %s %n", sub, "", "",
                            "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
                }
                ...
                for (Map.Entry<Application, Set<BillingSubscription>> billingEntries : billingSubs.entrySet()) {
                    ...
                    for (BillingSubscription billingSubscription : billingEntries.getValue()) {
                        ...
                        for (BillingSubscription.OperatorSubscription operatorSub : billingSubscription
                            ...
                            //START CHECK 	
                            if ((subscriberName.equalsIgnoreCase("__All__")) || (operatorSub.getOperator().equalsIgnoreCase(subscriberName))) {
                                ...
                                if (isPersistReport && fileWriter != null) {
                                    ...
                                    fileWriter.write(String.format("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s, %s, %s, %s, %s, %s %n", "", "",
                                            "", "", operatorSub.getOperator(), BillingDataAccessObject.getOperationNameById(operatorSub.getOperationId()), operatorSub.getRate().getName(), currencyStr,
            ...
            Map<Application, Set<BillingSubscription>> billingSubs = SbHostObjectUtils.chargeSubscriberForMonth(subscriberName,
                    year,
                    month,
                    rateCard);
            if (isPersistReport) {
                fileWriter.write(String.format("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s %n", subscriberName, "", "",
                        "", "", "", "", "", "", "", "", "", "", "", "", "", ""));
            }
            ...
            for (Map.Entry<Application, Set<BillingSubscription>> billingEntries : billingSubs.entrySet()) {
                ...
                for (BillingSubscription billingSubscription : billingEntries.getValue()) {
                    ...
                    for (BillingSubscription.OperatorSubscription operatorSub : billingSubscription
                        ...
                        if ((operatorName.equalsIgnoreCase("__All__")) || (operatorSub.getOperator().equalsIgnoreCase(operatorName))) {
                    ...
                    while (apis.hasNext()) {
                        ...
                        while (operations.hasNext()) {
                            ...
                            while (rates.hasNext()) {
                                ...
                                OMElement rootAttr = rate.getFirstChildWithName(HostObjectConstants.RATE_ATTRIBUTES_ELEMENT);
                                if (rootAttr != null) {
                                    Map<String, String> attributesMap = new HashMap<String, String>();
                                    for (Iterator childElements = rootAttr.getChildElements(); childElements.hasNext();) {
