...
public class AxiataDataAccessObject {
    ...
    public static List<String> getAllOperators() throws APIMgtUsageQueryServiceClientException, SQLException {
        ...
        try {
            ...
            System.out.println("Error occured while getting All Operators from the database" + e);
            //handleException("Error occured while getting All Operators from the database", e);
        } finally {
    ...
    public static List<Integer> getApplicationsByOperator(String operatorName) throws APIMgtUsageQueryServiceClientException, SQLException {
        ...
        try {
            ...
            System.out.println("Error occured while getting application ids from the database" + e);
            //handleException("Error occured while getting All Operators from the database", e);
        } finally {
            APIMgtDBUtil.closeAllConnections(ps, conn, results);
        }
    ...
    public static List<String> getOperatorNamesByApplication(int applicationId) throws APIMgtUsageQueryServiceClientException, SQLException {
        ...
        try {
            ...
            System.out.println("Error occured while getting operator names from the database" + e);
            //handleException("Error occured while getting All Operators from the database", e);
        } finally {
            APIMgtDBUtil.closeAllConnections(ps, conn, results);
        }
    ...
    public static String getApprovedOperatorsByApplication(int applicationId, String operator) {
        ...
        try {
            ...
            System.out.println("Error occured while getting approved operators of application from the database" + e);
            //handleException("Error occured while getting approved operators of application from the database", e);
        } finally {
            APIMgtDBUtil.closeAllConnections(ps, conn, rs);
        }
