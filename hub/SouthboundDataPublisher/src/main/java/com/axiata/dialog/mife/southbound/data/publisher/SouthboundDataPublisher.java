...
public class SouthboundDataPublisher {
    ...
    public void init() {
        try {
            ...
            if (!dataPublisher.isStreamDefinitionAdded(SouthboundPublisherConstants.MIFE_SOUTHBOUND_REQUEST_STREAM_NAME,
                    SouthboundPublisherConstants.MIFE_SOUTHBOUND_REQUEST_STREAM_VERSION)) {
                ...
                dataPublisher.addStreamDefinition(requestStreamDefinition,
                        SouthboundPublisherConstants.MIFE_SOUTHBOUND_REQUEST_STREAM_NAME,
                        SouthboundPublisherConstants.MIFE_SOUTHBOUND_REQUEST_STREAM_VERSION);
            }

            //If Response Stream Definition does not exist.
            if(!dataPublisher.isStreamDefinitionAdded(SouthboundPublisherConstants.MIFE_SOUTHBOUND_RESPONSE_STREAM_NAME,
                     SouthboundPublisherConstants.MIFE_SOUTHBOUND_RESPONSE_STREAM_VERSION)){
                ...
                dataPublisher.addStreamDefinition(responseStreamDefinition,
                        SouthboundPublisherConstants.MIFE_SOUTHBOUND_RESPONSE_STREAM_NAME,
                        SouthboundPublisherConstants.MIFE_SOUTHBOUND_RESPONSE_STREAM_VERSION);
    ...
    public void publishEvent(SouthboundRequestPublisherDTO southboundRequestPublisherDTO) {
        try {
            ...
            dataPublisher.publish(SouthboundPublisherConstants.MIFE_SOUTHBOUND_REQUEST_STREAM_NAME,
                    SouthboundPublisherConstants.MIFE_SOUTHBOUND_REQUEST_STREAM_VERSION,
    ...
    public void publishEvent(SouthboundResponsePublisherDTO southboundResponsePublisherDTO) {
        try {
            ...
            dataPublisher.publish(SouthboundPublisherConstants.MIFE_SOUTHBOUND_RESPONSE_STREAM_NAME,
                    SouthboundPublisherConstants.MIFE_SOUTHBOUND_RESPONSE_STREAM_VERSION,
                    System.currentTimeMillis(), new Object[]{"external"}, null,
