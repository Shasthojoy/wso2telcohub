...
public class SouthboundResponsePublisherDTO extends ResponsePublisherDTO {
    ...
    public static String getStreamDefinition() {
        String streamDefinition = "{"
                + "  'name':'" + SouthboundPublisherConstants.MIFE_SOUTHBOUND_RESPONSE_STREAM_NAME + "',"
                + "  'version':'" + SouthboundPublisherConstants.MIFE_SOUTHBOUND_RESPONSE_STREAM_VERSION + "',"
                + "  'nickName': 'MIFE Southbound Response Data',"
                + "  'description': 'MIFE Southbound Response Data',"
                + "  'metaData':["
