...
public class SouthboundRequestPublisherDTO extends RequestPublisherDTO {
    ...
    public static String getStreamDefinition() {
        String streamDefinition = "{" +
                "  'name':'" + SouthboundPublisherConstants.MIFE_SOUTHBOUND_REQUEST_STREAM_NAME + "'," +
                "  'version':'" + SouthboundPublisherConstants.MIFE_SOUTHBOUND_REQUEST_STREAM_VERSION + "'," +
                "  'nickName': 'MIFE Southbound Request Data'," +
                "  'description': 'MIFE Southbound Request Data'," +
                "  'metaData':[" +
