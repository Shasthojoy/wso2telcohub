...
public class NorthboundResponsePublisherDTO extends ResponsePublisherDTO {
    ...
    public static String getStreamDefinition() {
        String streamDefinition = "{" +
                "  'name':'" + SouthboundPublisherConstants.MIFE_NORTHBOUND_RESPONSE_STREAM_NAME + "'," +
                "  'version':'" + SouthboundPublisherConstants.MIFE_NORTHBOUND_RESPONSE_STREAM_VERSION + "'," +
                "  'nickName': 'MIFE Northbound Response Data'," +
                "  'description': 'MIFE Northbound Response Data'," +
                "  'metaData':[" +
