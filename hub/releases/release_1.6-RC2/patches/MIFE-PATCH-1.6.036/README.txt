=====================================
Incident: MIFE-815 / I-015006
Note - mifehub 1.6 prd | no transaction log report generated for SP that using self regenerate token. This will resolve following issues as well.
       No transaction log report generated for different "from" and "To" months and Data will be shown in browser Unexpectedly.	 
...
2)2) Apply 'manage' jaggery app changes on puppet master;
	a) On puppet master, navigate to "/mnt/puppet/environments/qa_rel_160/modules/apimanager/files/patches".
