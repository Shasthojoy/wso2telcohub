...
1) Apply AxiataMediator-1.0.0.jar and southbound-data-publisher-1.0.0.jar to API Manager on puppet master;
	...
	d) Copy and paste the 'AxiataMediator-1.0.0.jar'  and 'southbound-data-publisher-1.0.0.jar' into pupet master folder navigated to in step b). (Patch source is available under "/wso2am-1.7.0/repository/components/dropins".)
