=====================================
Incident: MIFE-702, MIFE-703 / I-015687
Note - Monthly Invoice report and Revenue Breakdown report is not working. 	 
=====================================
...
2)2) Apply 'store' jaggery app changes on puppet master;
	a) On puppet master, navigate to "/mnt/puppet/environments/qa_rel_160/modules/apimanager/files/patches".
	...
	d) Copy and paste the folder 'store' in to pupet master folder navigated to in step b). (Patch source is available under "/wso2am-1.7.0/jaggeryapps/".)
