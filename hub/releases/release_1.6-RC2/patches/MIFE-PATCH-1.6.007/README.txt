=====================================
Incident: MIFE-659 / I-011896
iTop Patch : MIFE-PATCH-1.6.007
=====================================

Please perform below modifications to the current HUB deployment to reflect the changes;

1) Apply manage jaggery app to API Manager on puppet master;
	...
	c) If the folder structure already exists, backup the contents under folders mentioned in step b.
	d) Copy and paste the "manage" folder in to pupet master folder navigated to in step b). (Patch source is available under "/wso2am-1.7.0/jaggeryapps/".)
