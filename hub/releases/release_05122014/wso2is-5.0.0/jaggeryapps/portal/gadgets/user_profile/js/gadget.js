function drawPage() {
	...
	if (json.return.fieldValues[i].displayName == 'Challenge Question1' ){
			json.return.fieldValues[i].fieldValue = "City where you were born ?";

	}
	if (json.return.fieldValues[i].displayName == 'Challenge Question2'){
		json.return.fieldValues[i].fieldValue = "Favorite Sport ?";
	}
