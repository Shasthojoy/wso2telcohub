$(document).ready(function(){
    ...
    $('.js_completeBtn').click(function(){
        ...
        btn.attr("disabled","disabled");
        jagg.post("/site/blocks/task-manager/ajax/task.jag", { action:"completeTask",status:status,taskId:taskId,taskType:"application",description:description,selectedTier:tierId },
            function (json) {
                if (!json.error) {
                    btn.next().show();
