...
// Function to set 'Default' tier.
function setDefaultTier() {
	$("select[name='tier']").change();
	var tiers = $('#tiersCollection').val();
	var tierVals = $("select[name='tier']").val();
	tierVals.push("Default");
	$('#tiersCollection').val(tierVals);
}
