...
--
-- Initial Metadata script for table `mcc_number_ranges`
--
INSERT INTO `mcc_number_ranges`(`id`,`mcccode`,`rangefrom`,`rangeto`,`mnccode`,`brand`,`isactive`,`note`,`created`,`created_date`,`lastupdated`,`lastupdated_date`) VALUES (1,'413',94760000000,94779999999,'02','Dialog',1,NULL,NULL,'2014-11-19 14:01:28',NULL,NULL);
