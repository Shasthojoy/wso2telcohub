            ...
            if(usage.length==0){
                ...
                for (var i = 0; i < usage.length; i++) {
                    ...
                    if(subscriber.applications.length > 0){
                        ...
                        for (var j = 0; j < subscriber.applications.length; j++) {
                            ...
                            if(application.subscriptions){
                                for (var k = 0; k < application.subscriptions.length; k++) {
                                    ...
                                    cell9.innerHTML = currency.concat((subscription.credit).toFixed(2));
                                    ...
                                    tatalsubCredit = tatalsubCredit + subscription.credit;
                        ...
                        var cell8 = document.createElement("td");
                        cell8.innerHTML = currency.concat(tatalsubCredit.toFixed(2)).bold();
                        rowTotal.appendChild(cell8);                                                

                        var cell9 = document.createElement("td");
                        cell9.innerHTML = currency.concat((totalPrice + totalTax).toFixed(2)).bold();
