...
public class HTTPPoster implements Runnable {
    ...
    private byte[] destNodeId;
    private Gson gson;
    private RequestManager manager;

    public HTTPPoster(String targetURL, String urlParameters, boolean auth, String senderaddr,byte[] destNodeId) {
    ...
    public String excutePost() {
        ...
        try {
            ...
            try {
                ...
                ussdHandler.sendMessage(sender, outboundMsg.getOutboundUSSDMessageRequest().getAddress(), outboundMsg.getOutboundUSSDMessageRequest().getOutboundUSSDMessage(), false, outboundMsg.getOutboundUSSDMessageRequest().getSessionID(), id.intValue(), isRegistered, isEndsession,destNodeId);
