package com.dialog.rnd.iris.smpp.util;


/**
 * Title		:SMPP34Data.java
...
public class SMPP34Data {	
		public static final int EX_PDU_BUF_EXPD_SIZE	= 16;
		
    	public static final int BIND_MODE_TX         = 0;
    	public static final int BIND_MODE_RX         = 1;
    	public static final int BIND_MODE_TXRX       = 2;
	    ...
	    static private byte defaultTon = SMPP34Data.DFLT_GSM_TON;
	    static private byte defaultNpi = SMPP34Data.DFLT_GSM_NPI;
