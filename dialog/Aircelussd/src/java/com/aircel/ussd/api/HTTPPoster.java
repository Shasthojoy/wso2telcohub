...
public class HTTPPoster implements Runnable {
    ...
    //public static String excutePost(String targetURL, String urlParameters, boolean auth) {
        ...
        try {
            ...
            SystemLog.getInstance().getLogger("smscomp_event").info("mc response received");
            ...
            try {
                ...
                SystemLog.getInstance().getLogger("smscomp_event").debug("outboundMsg :" + outboundMsg);
                ...
                if (outboundMsg.getOutboundUSSDMessageRequest().getUssdAction() == USSDAction.mtfin) {
                    isEndsession = true;
                    SystemLog.getInstance().getLogger("smscomp_event").info("mtfin received");
                }
                ...
                SystemLog.getInstance().getLogger("smscomp_event").error("Exception ussdHandler.sendMessage : " + e.getMessage());
                return null;
            }
            //==========================================================PRIYANKA_06608==============================================================================================================            
