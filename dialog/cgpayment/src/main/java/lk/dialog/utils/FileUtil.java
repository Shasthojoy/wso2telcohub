...
//        try {
//            //HttpServletRequest request,FileItem item,String db,String userID
//            String uploadedFileFullPath = item.getName();
//            String realFileName = uploadedFileFullPath.substring(uploadedFileFullPath.lastIndexOf("\\") + 1);
//            File uploadedFile = new File(tempFolderName + "\\" + realFileName);
...
//    }
    ...
    static {
		try {
			props.load(FileUtil.class.getClassLoader().getResourceAsStream("application.properties"));
