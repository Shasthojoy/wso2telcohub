        ...
        while (true) {
            try {
               ...
               for (PacketObject pObj : msgs) {
                    ...
                    SystemLog.getInstance().getLogger("smscomp_event").info("msg.getDeliverMessageId :" + msg.getMessageId());
                    SystemLog.getInstance().getLogger("smscomp_event").info("msg.getDeliverMessage :" + msg.getMessage());
                    SystemLog.getInstance().getLogger("smscomp_event").info("msg.getDeliverMessageText :" + msg.getMessageText());
