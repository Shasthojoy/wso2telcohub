...
public class SmsService {
    ...
    public ISMSresponse retriveSMS(String registrationId, String maxBatchSize) {
        //TO-DO - Validations
        ...
        try {
           ...
           if (app == null) {
            ...
            requesterror.setServiceException(new ServiceException("SVC0004", "Registration Not Found: "+registrationId, ""));
    ...
    public ISMSresponse subscribeToNotify(SubscribeRequest req, String registrationId) throws Exception {
        ...
        //TO-DO validate application exist
    ...
    public boolean ideaMartSend(SMSRequest smsReq, int msgNum) {
        //TO-DO - Validations
	...
	public String insertSmppSubscriptionIfExists(Integer smscRefNumber,String deliveryStatus, String resAddress, String callbackData,String senderAddress, String clientCorrelator) {
		String result="";
		if(am.idExistsForMsisdn(senderAddress)){
			result=am.insertSmppSubscriptionIfExists( smscRefNumber, deliveryStatus,  resAddress,  callbackData, senderAddress,  clientCorrelator);
		}
		return result;
	}
