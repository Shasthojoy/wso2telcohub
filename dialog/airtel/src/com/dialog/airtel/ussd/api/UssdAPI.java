package com.dialog.airtel.ussd.api;
...
import com.dialog.airtel.ussd.ctrl.RequestManager;
import com.dialog.airtel.ussd.ctrl.UrlProvisionEntity;
import com.dialog.airtel.ussd.dto.Application;
import com.dialog.airtel.ussd.dto.InboundMessage;
import com.dialog.airtel.ussd.dto.InboundUSSDMessageRequest;
import com.dialog.airtel.ussd.dto.NIMsisdn;
import com.dialog.airtel.ussd.dto.OutboundMessage;
import com.dialog.airtel.ussd.dto.OutboundRequest;
import com.dialog.airtel.ussd.dto.USSDAction;
import com.dialog.airtel.ussd.dto.VXMLFactory;
import com.dialog.airtel.ussd.dto.Vxml;
import com.dialog.airtel.ussd.dto.Vxml.Form;
import com.dialog.airtel.ussd.dto.Vxml.Form.Block;
import com.dialog.airtel.ussd.dto.Vxml.Form.Field;
import com.dialog.airtel.ussd.dto.Vxml.Form.Filled;
import com.dialog.airtel.ussd.dto.Vxml.Form.Filled.Assign;
import com.dialog.airtel.ussd.dto.Vxml.Form.Filled.Goto;
...
import com.dialog.airtel.ussd.util.AirTelSSLSocket;
/**
...
public class UssdAPI {
	...
	public Response ussdRoute(@Context HttpServletRequest hsr,@Context HttpServletResponse servletResponse,@FormParam("MSISDN") String msisdn, @FormParam("input") String  userinput, @FormParam("dateformat") String dateformat, @FormParam("sessionid") String sessionid ) {
...
*/	
	...
	private String createVXMLPage(String prompt, String callbackURI, String filledName, String filledExpr, String gotoURL) throws JAXBException, PropertyException {
		...
		//</block>
		com.dialog.airtel.ussd.dto.Vxml.Form.Block.Goto blockGoto = factory.createVxmlFormBlockGoto();
