 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NotUnderstoodType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "NotUnderstoodType",
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            new javax.xml.namespace.QName("","qname"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localQname));
    ...
    public static class Factory{
        ...
        */
        public static NotUnderstoodType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NotUnderstoodType object =
                new NotUnderstoodType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NotUnderstoodType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NotUnderstoodType)dialog.es.telefonica.mobileconnect.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    java.lang.String tempAttribQname =
                        
                                reader.getAttributeValue(null,"qname");
                            
                   if (tempAttribQname!=null){
                         java.lang.String content = tempAttribQname;
                        
                                int index = tempAttribQname.indexOf(":");
                                if(index > -1){
                                ...
                                namespaceuri = reader.getNamespaceURI(prefix);
                                         ...
                                         object.setQname(
                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToQName(tempAttribQname,namespaceuri));
