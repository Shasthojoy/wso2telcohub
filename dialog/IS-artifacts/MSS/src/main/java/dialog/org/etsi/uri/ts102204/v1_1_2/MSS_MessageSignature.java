 ...
 */
            ...
            /**
            *  MSS_MessageSignature bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns5");
                        ...
                        */
                                    ...
                                    protected dialog.org.w3.www._2000._09.xmldsig.SignatureType localSignature ;
                           ...
                           */
                           public  dialog.org.w3.www._2000._09.xmldsig.SignatureType getSignature(){
                            ...
                            /**
                               ...
                               */
                               public void setSignature(dialog.org.w3.www._2000._09.xmldsig.SignatureType param){
                        ...
                        */
                                    ...
                                    protected boolean localMustUnderstand =
                           ...
                           */
                           public  boolean getMustUnderstand(){
                            ...
                            /**
                               ...
                               */
                               public void setMustUnderstand(boolean param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MSS_MessageSignature",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MSS_MessageSignature",
                           xmlWriter);
                                            ...
                                            if (localRole != null){
                                                ...
                                                writeAttribute("http://www.w3.org/2003/05/soap-envelope",
                                                         "role",
                                                ...
                                                writeAttribute("http://www.w3.org/2003/05/soap-envelope",
                                                         "mustUnderstand",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMustUnderstand), xmlWriter);
                                           ...
                                           localSignature.serialize(new javax.xml.namespace.QName("http://www.w3.org/2000/09/xmldsig#","Signature"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            new javax.xml.namespace.QName("http://www.w3.org/2003/05/soap-envelope","mustUnderstand"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMustUnderstand));
    ...
    public static class Factory{
        ...
        */
        public static MSS_MessageSignature parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MSS_MessageSignature object =
                new MSS_MessageSignature();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MSS_MessageSignature".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MSS_MessageSignature)dialog.es.telefonica.mobileconnect.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    java.lang.String tempAttribRole =
                                ...
                                reader.getAttributeValue("http://www.w3.org/2003/05/soap-envelope","role");
                   ...
                   if (tempAttribRole!=null){
                    ...
                    java.lang.String tempAttribMustUnderstand =
                        
                                reader.getAttributeValue("http://www.w3.org/2003/05/soap-envelope","mustUnderstand");
                            
                   if (tempAttribMustUnderstand!=null){
                         java.lang.String content = tempAttribMustUnderstand;
                        
                                                 object.setMustUnderstand(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(tempAttribMustUnderstand));
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.w3.org/2000/09/xmldsig#","Signature").equals(reader.getName())){
                                                ...
                                                object.setSignature(dialog.org.w3.www._2000._09.xmldsig.SignatureType.Factory.parse(reader));
