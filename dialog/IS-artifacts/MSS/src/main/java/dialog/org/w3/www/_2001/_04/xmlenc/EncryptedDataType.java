 ...
 */
            ...
            /**
            *  EncryptedDataType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EncryptedDataType extends dialog.org.w3.www._2001._04.xmlenc.EncryptedType
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EncryptedDataType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EncryptedDataType",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://www.w3.org/2001/04/xmlenc#","EncryptedDataType"));
                 if (localEncryptionMethodTracker){
    ...
    public static class Factory{
        ...
        */
        public static EncryptedDataType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EncryptedDataType object =
                new EncryptedDataType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EncryptedDataType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EncryptedDataType)dialog.es.telefonica.mobileconnect.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
