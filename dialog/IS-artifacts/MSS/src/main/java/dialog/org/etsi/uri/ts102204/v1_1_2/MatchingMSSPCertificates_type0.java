...
/**
 * MatchingMSSPCertificates_type0.java
 *
 ...
 */
            ...
            /**
            *  MatchingMSSPCertificates_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class MatchingMSSPCertificates_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = MatchingMSSPCertificates_type0
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  javax.activation.DataHandler[] getCertificate(){
                               ...
                               */
                              protected void validateCertificate(javax.activation.DataHandler[] param){
                             ...
                             */
                             public void addCertificate(javax.activation.DataHandler param){
                                   if (localCertificate == null){
                                   localCertificate = new javax.activation.DataHandler[]{};
                                   }
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MatchingMSSPCertificates_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MatchingMSSPCertificates_type0",
                           xmlWriter);
                   }
                                   ...
                                   for (int i = 0;i < localCertificate.length;i++){
                                            ...
                                            if (localCertificate[i] != null){
                                                ...
                                                writeStartElement(null, namespace, "Certificate", xmlWriter);
                                                        ...
                                                        try {
                                                            org.apache.axiom.util.stax.XMLStreamWriterUtils.writeDataHandler(xmlWriter, localCertificate[i], null, true);
                                                        } catch (java.io.IOException ex) {
                                                            throw new javax.xml.stream.XMLStreamException("Unable to read data handler for Certificate[" + i + "]", ex);
                                                        }
    ...
    public static class Factory{
        ...
        */
        public static MatchingMSSPCertificates_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MatchingMSSPCertificates_type0 object =
                new MatchingMSSPCertificates_type0();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MatchingMSSPCertificates_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MatchingMSSPCertificates_type0)dialog.es.telefonica.mobileconnect.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://uri.etsi.org/TS102204/v1.1.2#","Certificate").equals(reader.getName())){
                                    ...
                                    list1.add(org.apache.axiom.util.stax.XMLStreamReaderUtils.getDataHandlerFromElement(reader));
                                                ...
                                                while(!loopDone1){
                                                    ...
                                                    if (reader.isEndElement()){
                                                        ...
                                                        if (new javax.xml.namespace.QName("http://uri.etsi.org/TS102204/v1.1.2#","Certificate").equals(reader.getName())){
                                                             list1.add(org.apache.axiom.util.stax.XMLStreamReaderUtils.getDataHandlerFromElement(reader));
                                                ...
                                                object.setCertificate((javax.activation.DataHandler[])
