 ...
 */
            ...
            /**
            *  CipherReferenceType bean class
            */
            ...
            private void clearAllSettingTrackers() {
                   ...
                   localTransformsTracker = false;
                        ...
                        */
                                    ...
                                    protected dialog.org.w3.www._2001._04.xmlenc.TransformsType localTransforms ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.w3.www._2001._04.xmlenc.TransformsType
                           */
                           public  dialog.org.w3.www._2001._04.xmlenc.TransformsType getTransforms(){
                            ...
                            /**
                               ...
                               */
                               public void setTransforms(dialog.org.w3.www._2001._04.xmlenc.TransformsType param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CipherReferenceType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CipherReferenceType",
                           xmlWriter);
                                     ...
                                     if (localTransformsTracker){
                                           ...
                                           localTransforms.serialize(new javax.xml.namespace.QName("http://www.w3.org/2001/04/xmlenc#","Transforms"),
                                               xmlWriter);
                                        }
    ...
    public static class Factory{
        ...
        */
        public static CipherReferenceType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CipherReferenceType object =
                new CipherReferenceType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CipherReferenceType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CipherReferenceType)dialog.es.telefonica.mobileconnect.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.w3.org/2001/04/xmlenc#","Transforms").equals(reader.getName())){
                                
                                                object.setTransforms(dialog.org.w3.www._2001._04.xmlenc.TransformsType.Factory.parse(reader));
