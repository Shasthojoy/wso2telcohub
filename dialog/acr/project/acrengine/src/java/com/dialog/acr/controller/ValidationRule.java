...
public class ValidationRule {
	...
	public static boolean isMandatory(int type) {
		...
		case VALIDATION_TYPE_MANDATORY_PAYMENT_CHANNEL: mandatory=true; break;
                case VALIDATION_TYPE_MANDATORY_MESSAGE: mandatory=true; break;
                case VALIDATION_TYPE_MANDATORY_CURRENCY: mandatory=true; break;
                case VALIDATION_TYPE_MANDATORY_TEL_END_USER_ID: mandatory=true; break;
		}
