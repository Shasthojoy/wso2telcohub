...
public class SendSMSHandler implements SMSHandler {
    ...
    public boolean handle(MessageContext context) throws AxiataException, AxisFault, Exception {
        ...
        Map<String, SendSMSResponse> smsResponses = smssendmulti(context, subsrequest, jsonBody.getJSONObject
                ("outboundSMSMessageRequest").getJSONArray("address"), API_TYPE, executor.getValidoperators());
